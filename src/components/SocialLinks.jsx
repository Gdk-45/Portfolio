      ...
      <div className="flex flex-col h-[50vh] justify-center items-center">
        ...
        <div className="flex space-x-6 mt-6">
          ...
          <Tooltip title="YouTube">
            <a href="https://www.youtube.com/@Dsa_withjay" target="_blank" rel="noopener noreferrer">
          ...
          <Tooltip title="LeetCode">
            <a href="https://leetcode.com/dattuajay005/" target="_blank" rel="noopener noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e8eaed" className="transform transition-transform duration-300 hover:scale-125">
